...
var bindings = require('libxmljs/lib/bindings');

// document parsing for backwards compat
var Document = require('libxmljs/lib/document');
...
// constants
module.exports.version = require('libxmljs/package.json').version;
...
// lib exports
module.exports.Comment = require('libxmljs/lib/comment');
module.exports.Document = Document;
module.exports.Element = require('libxmljs/lib/element');
module.exports.ProcessingInstruction = require('libxmljs/lib/pi');
module.exports.Text = require('libxmljs/lib/text');
...
var sax_parser = require('libxmljs/lib/sax_parser');
